        ...
        <form id="<?php echo esc_attr($form_id); ?>" class="nc-form nc-calculator-form">
            ...
            <div class="nc-form-row">
                ...
                <div class="nc-form-group nc-partner-1">
                    ...
                    <div class="nc-field nc-required">
                        <label for="person1_date-<?php echo esc_attr($instance_id); ?>"><?php _e('Date of Birth', 'numerology-compatibility'); ?></label>
                        <input type="date" id="person1_date-<?php echo esc_attr($instance_id); ?>" name="person1_date" required
                ...
                <div class="nc-form-group nc-partner-2">
                    ...
                    <div class="nc-field nc-required">
                        <label for="person2_date-<?php echo esc_attr($instance_id); ?>"><?php _e('Date of Birth', 'numerology-compatibility'); ?></label>
                        <input type="date" id="person2_date-<?php echo esc_attr($instance_id); ?>" name="person2_date" required
                               max="<?php echo date('Y-m-d'); ?>"
                               min="1900-01-01">
                        <span class="nc-error-message nc-hidden"></span>
                    </div>
            ...
            <div class="nc-consent-group">
                <div class="nc-checkbox-group">
                    <label class="nc-checkbox">
                        <input type="checkbox" name="harm_consent" id="harm_consent-<?php echo esc_attr($instance_id); ?>" required>
                    ...
                    <label class="nc-checkbox">
                        <input type="checkbox" name="entertainment_consent" id="entertainment_consent-<?php echo esc_attr($instance_id); ?>" required>
            ...
            <div class="nc-form-actions">
                <button type="submit" class="nc-btn nc-btn-primary nc-btn-large">
                    <?php _e('Calculate', 'numerology-compatibility'); ?> →
                </button>
            </div>
        </form>
    </div>
    ...
    <div class="nc-step nc-step-5 nc-hidden" data-step="5">
        <div class="nc-success nc-generating">
            ...
            <div class="nc-pdf-download">
                <a href="#" id="nc-pdf-download-link-<?php echo esc_attr($instance_id); ?>" class="nc-btn nc-btn-primary nc-btn-large nc-hidden nc-pdf-download-link" target="_blank">
            ...
            <!-- Email Form (Optional) - shown when PDF is ready -->
            <div class="nc-email-form nc-hidden">
                ...
                <form id="nc-send-email-form-<?php echo esc_attr($instance_id); ?>" class="nc-form nc-send-email-form">
                    <div class="nc-field">
                        <label for="email-after-calc-<?php echo esc_attr($instance_id); ?>"><?php _e('Email Address', 'numerology-compatibility'); ?></label>
                        <input type="email" id="email-after-calc-<?php echo esc_attr($instance_id); ?>" name="email"
                               class="nc-email-after-calc"
