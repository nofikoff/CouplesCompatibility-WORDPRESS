	...
	public function enqueue_scripts() {
		...
		wp_localize_script($this->plugin_name . '-calculator', 'nc_public', [
			...
			'i18n' => [
				...
				'pdf_generation_failed' => __('PDF generation failed after multiple attempts. Please try to reload page or contact support if the problem persists.', 'numerology-compatibility'),
